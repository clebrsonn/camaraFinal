...
public class DaoGenericoImpl<T, ID extends Serializable> implements DaoGenerico<T, ID> {
	...
	public DaoGenericoImpl() {
		this.oClass = (Class<T>)( (ParameterizedType) getClass().getGenericSuperclass() ).
	...
	public T pesquisarPorUserNameEsenha(String username) {

		return (T) getEntityManager().find(oClass, username);
	}
}
