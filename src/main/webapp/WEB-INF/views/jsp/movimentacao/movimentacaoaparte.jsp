...
<div id="conteudo" class="conteudo">
      ...
      <table class="flatTable">
    	...
    	<tr class="titleTr">
				    <td class="titleTd">Apartes</td>
				       <td class="search"> <input type="text"></td>
				    <td colspan="2"></td>
				    <td><a href="${pageContext.request.contextPath}/aparte/cadastrar"  ><img src="${pageContext.request.contextPath}/resources/images/add.png"></div></a></td>
  				</tr>
